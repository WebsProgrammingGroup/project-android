...
public class WEBS_Q_A_NOTICE extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.webs_q_a_notice);
		btn1 =(Button)findViewById(R.id.webs_q_a_board_add);
		lv =(ListView)findViewById(R.id.lv_webs_q_a_board_notice);
