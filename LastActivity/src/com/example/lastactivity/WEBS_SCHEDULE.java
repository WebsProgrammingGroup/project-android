...
public class WEBS_SCHEDULE extends Activity implements OnClickListener,
		OnItemClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.webs_schedule);
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,long id) {
		tY=textYear.getText().toString();
		tM=textMon.getText().toString();
