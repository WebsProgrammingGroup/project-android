...
public class WEBS_OB_YB_NOTICE extends Activity {
	Button btn1;
	ListView lv;
	String strurl = "http://wpg.azurewebsites.net/webs_ob_yb_notice.jsp?";
	Context mctx;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.webs_ob_yb_notice_main);
		btn1 = (Button) findViewById(R.id.webs_ob_yb_board_add);
		lv = (ListView) findViewById(R.id.lv_webs_ob_yb_board_notice);
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				intent1.putExtra("content", "ob_yb");
			}
		});
		...
		btn1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.putExtra("content", "obybboard");
