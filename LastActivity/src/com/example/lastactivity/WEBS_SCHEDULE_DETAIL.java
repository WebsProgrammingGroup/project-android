...
public class WEBS_SCHEDULE_DETAIL extends Activity implements OnClickListener{
	WEBS_SCHEDULE_DBLITE mDBHelper;
	int mId;
	String today;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mDBHelper = new WEBS_SCHEDULE_DBLITE(this, "Today.db", null, 1);
